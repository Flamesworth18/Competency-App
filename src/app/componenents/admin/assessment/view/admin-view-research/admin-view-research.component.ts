...
@Component({
  selector: 'app-admin-view-research',
  templateUrl: './admin-view-research.component.html',
  styleUrls: ['./admin-view-research.component.scss']
})
export class AdminViewResearchComponent implements OnInit {
  ...
  //SAVE UPDATED RESEARCH COMPETENCY
  saveUpdate(){
  ...
  //#region GET RESEARCH COMPETENCY ONE DATA
  getCategoryOneOptions(){
    this.researchCompetencyService.getCategoryOneOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryOneResults(){
    this.researchCompetencyService.getCategoryOneResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryTwoOptions(){
    this.researchCompetencyService.getCategoryTwoOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryTwoResults(){
    this.researchCompetencyService.getCategoryTwoResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryThreeOptions(){
    this.researchCompetencyService.getCategoryThreeOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryThreeResults(){
    this.researchCompetencyService.getCategoryThreeResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFourOptions(){
    this.researchCompetencyService.getCategoryFourOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFourResults(){
    this.researchCompetencyService.getCategoryFourResults(this.competency.id)
    .subscribe(
      res => {
  ...
  //#region GET RESEARCH COMPETENCY FIVE DATA
  getCategoryFiveOptions(){
    this.researchCompetencyService.getCategoryFiveOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFiveResults(){
    this.researchCompetencyService.getCategoryFiveResults(this.competency.id)
    .subscribe(
      res => {
  ...
  //#region GET RESEARCH COMPETENCY SIX DATA
  getCategorySixOptions(){
    this.researchCompetencyService.getCategorySixOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategorySixResults(){
    this.researchCompetencyService.getCategorySixResults(this.competency.id)
    .subscribe(
      res => {
  ...
  //#region RESEARCH 1 OPTIONS CHANGED
...
//#endregion
  ...
  //#region RESEARCH 2 OPTIONS CHANGED
...
//#endregion
  ...
  //#region RESEARCH 3 OPTIONS CHANGED
...
//#endregion
  ...
  //#region RESEARCH 4 OPTIONS CHANGED
...
//#endregion
  ...
  //#region RESEARCH 5 OPTIONS CHANGED
...
//#endregion
  ...
  //#region RESEARCH 6 OPTIONS CHANGED
...
//#endregion
  ...
  updateCompetencyOne(){
    this.researchCompetencyService.updateCompetencyOne(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyTwo(){
    this.researchCompetencyService.updateCompetencyTwo(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyThree(){
    this.researchCompetencyService.updateCompetencyThree(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyFour(){
    this.researchCompetencyService.updateCompetencyFour(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyFive(){
    this.researchCompetencyService.updateCompetencyFive(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencySix(){
    this.researchCompetencyService.updateCompetencySix(this.competency.id, this.competency)
    .subscribe(
      res => {
