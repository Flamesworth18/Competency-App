...
import { LeadershipCompetencyCategories } from 'src/app/competencies/leadership-competency';
import { LeadershipCompetency } from 'src/app/models/competency/leadership-competency.model';
import { NgxSpinnerService } from 'ngx-spinner';
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: 'app-admin-view-leadership',
  templateUrl: './admin-view-leadership.component.html',
  styleUrls: ['./admin-view-leadership.component.scss']
})
export class AdminViewLeadershipComponent implements OnInit {
  ...
  //SAVE UPDATED LEADERSHIP COMPETENCY
  saveUpdate(){
  ...
  getCategoryOneOptions(){
    this.leadershipCompetencyService.getCategoryOneOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryOneResults(){
    this.leadershipCompetencyService.getCategoryOneResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryTwoOptions(){
    this.leadershipCompetencyService.getCategoryTwoOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryTwoResults(){
    this.leadershipCompetencyService.getCategoryTwoResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryThreeOptions(){
    this.leadershipCompetencyService.getCategoryThreeOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryThreeResults(){
    this.leadershipCompetencyService.getCategoryThreeResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFourOptions(){
    this.leadershipCompetencyService.getCategoryFourOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFourResults(){
    this.leadershipCompetencyService.getCategoryFourResults(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFiveOptions(){
    this.leadershipCompetencyService.getCategoryFiveOptions(this.competency.id)
    .subscribe(
      res => {
  ...
  getCategoryFiveResults(){
    this.leadershipCompetencyService.getCategoryFiveResults(this.competency.id)
    .subscribe(
      res => {
  ...
  //#region LEADERSHIP 1 OPTIONS CHANGED
...
//#endregion
  ...
  //#region LEADERSHIP 2 OPTIONS CHANGED
...
//#endregion
  ...
  //#region LEADERSHIP 3 OPTIONS CHANGED
...
//#endregion
  ...
  //#region LEADERSHIP 4 OPTIONS CHANGED
...
//#endregion
  ...
  //#region LEADERSHIP 5 OPTIONS CHANGED
...
//#endregion
  ...
  updateCompetencyOne(){
    this.leadershipCompetencyService.updateCompetencyOne(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyTwo(){
    this.leadershipCompetencyService.updateCompetencyTwo(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyThree(){
    this.leadershipCompetencyService.updateCompetencyThree(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyFour(){
    this.leadershipCompetencyService.updateCompetencyFour(this.competency.id, this.competency)
    .subscribe(
      res => {
  ...
  updateCompetencyFive(){
    this.leadershipCompetencyService.updateCompetencyFive(this.competency.id, this.competency)
    .subscribe(
      res => {
