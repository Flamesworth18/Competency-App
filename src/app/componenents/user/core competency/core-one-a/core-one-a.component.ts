...
@Component({
  selector: 'app-core-one-a',
  templateUrl: './core-one-a.component.html',
  styleUrls: ['./core-one-a.component.scss']
})
export class CoreOneAComponent implements OnInit {
  ...
  navigateToPagination(route: string){
    ...
    var basicOptions = this.userCoreCompetency.oneBasicOptions;
    var intermediateOptions = this.userCoreCompetency.oneIntermediateOptions;
    var advancedOptions = this.userCoreCompetency.oneAdvancedOptions;
    var superiorOptions = this.userCoreCompetency.oneSuperiorOptions;
    ...
    if(basicScore.length >= 6){
      this.userCoreCompetency.oneBasicResult.competent = true;
    }
    else if(basicScore.length >= 3 && basicScore.length <= 5){
      this.userCoreCompetency.oneBasicResult.partially = true;
    }
    else if(basicScore.length <= 2){
      this.userCoreCompetency.oneBasicResult.notYet = true;
    }
    //#endregion

    //#region INTERMEDIATE
    if(intermediateScore.length >= 6){
      this.userCoreCompetency.oneIntermediateResult.competent = true;
    }
    else if(intermediateScore.length >= 3 && intermediateScore.length <= 5){
      this.userCoreCompetency.oneIntermediateResult.partially = true;
    }
    else if(intermediateScore.length <= 2){
      this.userCoreCompetency.oneIntermediateResult.notYet = true;
    }
    //#endregion

    //#region ADVANCED
    if(advancedScore.length >= 6){
      this.userCoreCompetency.oneAdvancedResult.competent = true;
    }
    else if(advancedScore.length >= 3 && advancedScore.length <= 5){
      this.userCoreCompetency.oneAdvancedResult.partially = true;
    }
    else if(advancedScore.length <= 2){
      this.userCoreCompetency.oneAdvancedResult.notYet = true;
    }
    //#endregion

    //#region SUPERIOR
    if(superiorScore.length >= 6){
      this.userCoreCompetency.oneSuperiorResult.competent = true;
    }
    else if(superiorScore.length >= 3 && superiorScore.length <= 5){
      this.userCoreCompetency.oneSuperiorResult.partially = true;
    }
    else if(superiorScore.length <= 2){
      this.userCoreCompetency.oneSuperiorResult.notYet = true;
    }
    //#endregion
  ...
  addToBasicOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userCoreCompetency.oneBasicOptions.findIndex(o => o.id === option.id);
      this.userCoreCompetency.oneBasicOptions[optionIndex] = option;
    }
  }
  ...
  addToIntermediateOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userCoreCompetency.oneIntermediateOptions.findIndex(o => o.id == option.id);
      this.userCoreCompetency.oneIntermediateOptions[optionIndex] = option;
    }
  }
  ...
  addToAdvancedOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userCoreCompetency.oneAdvancedOptions.findIndex(o => o.id == option.id);
      this.userCoreCompetency.oneAdvancedOptions[optionIndex] = option;
    }
  }
  ...
  addToSuperiorOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userCoreCompetency.oneSuperiorOptions.findIndex(o => o.id == option.id);
      this.userCoreCompetency.oneSuperiorOptions[optionIndex] = option;
    }
  }
