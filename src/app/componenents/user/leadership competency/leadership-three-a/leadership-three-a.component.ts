import { LeadershipThreeAdvancedOptions } from './../../../../options/leadership/3/leadership-three-advanced';
import { LeadershipThreeIntermediateOptions } from './../../../../options/leadership/3/leadership-three-intermediate';
import { LeadershipThreeBasicOptions } from './../../../../options/leadership/3/leadership-three-basic';
...
@Component({
  selector: 'app-leadership-three-a',
  templateUrl: './leadership-three-a.component.html',
  styleUrls: ['./leadership-three-a.component.scss']
})
export class LeadershipThreeAComponent implements OnInit {
  ...
  navigateToPagination(route: string){
    ...
    var basicOptions = this.userLeadershipCompetency.threeBasicOptions;
    var intermediateOptions = this.userLeadershipCompetency.threeIntermediateOptions;
    var advancedOptions = this.userLeadershipCompetency.threeAdvancedOptions;
    var superiorOptions = this.userLeadershipCompetency.threeSuperiorOptions;
    ...
    if(basicScore.length >= 6){
      this.userLeadershipCompetency.threeBasicResult.competent = true;
    }
    else if(basicScore.length >= 3 && basicScore.length <= 5){
      this.userLeadershipCompetency.threeBasicResult.partially = true;
    }
    else if(basicScore.length <= 2){
      this.userLeadershipCompetency.threeBasicResult.notYet = true;
    }
    //#endregion

    //#region INTERMEDIATE
    if(intermediateScore.length >= 6){
      this.userLeadershipCompetency.threeIntermediateResult.competent = true;
    }
    else if(intermediateScore.length >= 3 && intermediateScore.length <= 5){
      this.userLeadershipCompetency.threeIntermediateResult.partially = true;
    }
    else if(intermediateScore.length <= 2){
      this.userLeadershipCompetency.threeIntermediateResult.notYet = true;
    }
    //#endregion

    //#region ADVANCED
    if(advancedScore.length >= 6){
      this.userLeadershipCompetency.threeAdvancedResult.competent = true;
    }
    else if(advancedScore.length >= 3 && advancedScore.length <= 5){
      this.userLeadershipCompetency.threeAdvancedResult.partially = true;
    }
    else if(advancedScore.length <= 2){
      this.userLeadershipCompetency.threeAdvancedResult.notYet = true;
    }
    //#endregion

    //#region SUPERIOR
    if(superiorScore.length >= 6){
      this.userLeadershipCompetency.threeSuperiorResult.competent = true;
    }
    else if(superiorScore.length >= 3 && superiorScore.length <= 5){
      this.userLeadershipCompetency.threeSuperiorResult.partially = true;
    }
    else if(superiorScore.length <= 2){
      this.userLeadershipCompetency.threeSuperiorResult.notYet = true;
    }
    //#endregion
  ...
  addToBasicOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.threeBasicOptions.findIndex(o => o.id === option.id);
      this.userLeadershipCompetency.threeBasicOptions[optionIndex] = option;
    }
  }
  ...
  addToIntermediateOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.threeIntermediateOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.threeIntermediateOptions[optionIndex] = option;
    }
  }
  ...
  addToAdvancedOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.threeAdvancedOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.threeAdvancedOptions[optionIndex] = option;
    }
  }
  ...
  addToSuperiorOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.threeSuperiorOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.threeSuperiorOptions[optionIndex] = option;
    }
  }
