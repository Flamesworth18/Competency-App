...
@Component({
  selector: 'app-leadership-four-b',
  templateUrl: './leadership-four-b.component.html',
  styleUrls: ['./leadership-four-b.component.scss']
})
export class LeadershipFourBComponent implements OnInit {
