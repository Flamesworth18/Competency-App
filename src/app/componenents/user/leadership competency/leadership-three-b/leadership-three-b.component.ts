...
@Component({
  selector: 'app-leadership-three-b',
  templateUrl: './leadership-three-b.component.html',
  styleUrls: ['./leadership-three-b.component.scss']
})
export class LeadershipThreeBComponent implements OnInit {
