import { LeadershipFourSuperiorOptions } from './../../../../options/leadership/4/leadership-four-superior';
import { LeadershipFourAdvancedOptions } from './../../../../options/leadership/4/leadership-four-advanced';
import { LeadershipFourIntermediateOptions } from './../../../../options/leadership/4/leadership-four-intermediate';
import { LeadershipFourBasicOptions } from './../../../../options/leadership/4/leadership-four-basic';
...
@Component({
  selector: 'app-leadership-four-a',
  templateUrl: './leadership-four-a.component.html',
  styleUrls: ['./leadership-four-a.component.scss']
})
export class LeadershipFourAComponent implements OnInit {
  ...
  navigateToPagination(route: string){
    ...
    var basicOptions = this.userLeadershipCompetency.fourBasicOptions;
    var intermediateOptions = this.userLeadershipCompetency.fourIntermediateOptions;
    var advancedOptions = this.userLeadershipCompetency.fourAdvancedOptions;
    var superiorOptions = this.userLeadershipCompetency.fourSuperiorOptions;
    ...
    if(basicScore.length >= 6){
      this.userLeadershipCompetency.fourBasicResult.competent = true;
    }
    else if(basicScore.length >= 3 && basicScore.length <= 5){
      this.userLeadershipCompetency.fourBasicResult.partially = true;
    }
    else if(basicScore.length <= 2){
      this.userLeadershipCompetency.fourBasicResult.notYet = true;
    }
    //#endregion

    //#region INTERMEDIATE
    if(intermediateScore.length >= 6){
      this.userLeadershipCompetency.fourIntermediateResult.competent = true;
    }
    else if(intermediateScore.length >= 3 && intermediateScore.length <= 5){
      this.userLeadershipCompetency.fourIntermediateResult.partially = true;
    }
    else if(intermediateScore.length <= 2){
      this.userLeadershipCompetency.fourIntermediateResult.notYet = true;
    }
    //#endregion

    //#region ADVANCED
    if(advancedScore.length >= 6){
      this.userLeadershipCompetency.fourAdvancedResult.competent = true;
    }
    else if(advancedScore.length >= 3 && advancedScore.length <= 5){
      this.userLeadershipCompetency.fourAdvancedResult.partially = true;
    }
    else if(advancedScore.length <= 2){
      this.userLeadershipCompetency.fourAdvancedResult.notYet = true;
    }
    //#endregion

    //#region SUPERIOR
    if(superiorScore.length >= 6){
      this.userLeadershipCompetency.fourSuperiorResult.competent = true;
    }
    else if(superiorScore.length >= 3 && superiorScore.length <= 5){
      this.userLeadershipCompetency.fourSuperiorResult.partially = true;
    }
    else if(superiorScore.length <= 2){
      this.userLeadershipCompetency.fourSuperiorResult.notYet = true;
    }
    //#endregion
  ...
  addToBasicOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fourBasicOptions.findIndex(o => o.id === option.id);
      this.userLeadershipCompetency.fourBasicOptions[optionIndex] = option;
    }
  }
  ...
  addToIntermediateOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fourIntermediateOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.fourIntermediateOptions[optionIndex] = option;
    }
  }
  ...
  addToAdvancedOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fourAdvancedOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.fourAdvancedOptions[optionIndex] = option;
    }
  }
  ...
  addToSuperiorOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fourSuperiorOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.fourSuperiorOptions[optionIndex] = option;
    }
  }
