...
@Component({
  selector: 'app-leadership-two-b',
  templateUrl: './leadership-two-b.component.html',
  styleUrls: ['./leadership-two-b.component.scss']
})
export class LeadershipTwoBComponent implements OnInit {
