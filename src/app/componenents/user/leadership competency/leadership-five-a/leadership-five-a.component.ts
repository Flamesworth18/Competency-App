import { LeadershipFiveSuperiorOptions } from './../../../../options/leadership/5/leadership-five-superior';
import { LeadershipFiveAdvancedOptions } from './../../../../options/leadership/5/leadership-five-advanced';
import { LeadershipFiveIntermediateOptions } from './../../../../options/leadership/5/leadership-five-intermediate';
import { LeadershipFiveBasicOptions } from './../../../../options/leadership/5/leadership-five-basic';
...
@Component({
  selector: 'app-leadership-five-a',
  templateUrl: './leadership-five-a.component.html',
  styleUrls: ['./leadership-five-a.component.scss']
})
export class LeadershipFiveAComponent implements OnInit {
  ...
  navigateToPagination(route: string){
    ...
    var basicOptions = this.userLeadershipCompetency.fiveBasicOptions;
    var intermediateOptions = this.userLeadershipCompetency.fiveIntermediateOptions;
    var advancedOptions = this.userLeadershipCompetency.fiveAdvancedOptions;
    var superiorOptions = this.userLeadershipCompetency.fiveSuperiorOptions;
    ...
    if(basicScore.length >= 6){
      this.userLeadershipCompetency.fiveBasicResult.competent = true;
    }
    else if(basicScore.length >= 3 && basicScore.length <= 5){
      this.userLeadershipCompetency.fiveBasicResult.partially = true;
    }
    else if(basicScore.length <= 2){
      this.userLeadershipCompetency.fiveBasicResult.notYet = true;
    }
    //#endregion

    //#region INTERMEDIATE
    if(intermediateScore.length >= 6){
      this.userLeadershipCompetency.fiveIntermediateResult.competent = true;
    }
    else if(intermediateScore.length >= 3 && intermediateScore.length <= 5){
      this.userLeadershipCompetency.fiveIntermediateResult.partially = true;
    }
    else if(intermediateScore.length <= 2){
      this.userLeadershipCompetency.fiveIntermediateResult.notYet = true;
    }
    //#endregion

    //#region ADVANCED
    if(advancedScore.length >= 6){
      this.userLeadershipCompetency.fiveAdvancedResult.competent = true;
    }
    else if(advancedScore.length >= 3 && advancedScore.length <= 5){
      this.userLeadershipCompetency.fiveAdvancedResult.partially = true;
    }
    else if(advancedScore.length <= 2){
      this.userLeadershipCompetency.fiveAdvancedResult.notYet = true;
    }
    //#endregion

    //#region SUPERIOR
    if(superiorScore.length >= 6){
      this.userLeadershipCompetency.fiveSuperiorResult.competent = true;
    }
    else if(superiorScore.length >= 3 && superiorScore.length <= 5){
      this.userLeadershipCompetency.fiveSuperiorResult.partially = true;
    }
    else if(superiorScore.length <= 2){
      this.userLeadershipCompetency.fiveSuperiorResult.notYet = true;
    }
    //#endregion
  ...
  addToBasicOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fiveBasicOptions.findIndex(o => o.id === option.id);
      this.userLeadershipCompetency.fiveBasicOptions[optionIndex] = option;
    }
  }
  ...
  addToIntermediateOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fiveIntermediateOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.fiveIntermediateOptions[optionIndex] = option;
    }
  }
  ...
  addToAdvancedOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fiveAdvancedOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.fiveAdvancedOptions[optionIndex] = option;
    }
  }
  ...
  addToSuperiorOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userLeadershipCompetency.fiveSuperiorOptions.findIndex(o => o.id == option.id);
      this.userLeadershipCompetency.fiveSuperiorOptions[optionIndex] = option;
    }
  }
