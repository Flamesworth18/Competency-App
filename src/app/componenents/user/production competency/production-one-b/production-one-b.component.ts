...
@Component({
  selector: 'app-producion-one-b',
  templateUrl: './production-one-b.component.html',
  styleUrls: ['./production-one-b.component.scss']
})
export class ProductionOneBComponent implements OnInit {
