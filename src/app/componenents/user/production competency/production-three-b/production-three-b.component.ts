...
@Component({
  selector: 'app-producion-three-b',
  templateUrl: './production-three-b.component.html',
  styleUrls: ['./production-three-b.component.scss']
})
export class ProductionThreeBComponent implements OnInit {
