...
@Component({
  selector: 'app-producion-two-b',
  templateUrl: './production-two-b.component.html',
  styleUrls: ['./production-two-b.component.scss']
})
export class ProductionTwoBComponent implements OnInit {
