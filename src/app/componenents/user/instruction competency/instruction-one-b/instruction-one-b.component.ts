...
@Component({
  selector: 'app-instruction-one-b',
  templateUrl: './instruction-one-b.component.html',
  styleUrls: ['./instruction-one-b.component.scss']
})
export class InstructionOneBComponent implements OnInit {
