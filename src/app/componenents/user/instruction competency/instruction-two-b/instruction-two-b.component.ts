...
@Component({
  selector: 'app-instruction-two-b',
  templateUrl: './instruction-two-b.component.html',
  styleUrls: ['./instruction-two-b.component.scss']
})
export class InstructionTwoBComponent implements OnInit {
