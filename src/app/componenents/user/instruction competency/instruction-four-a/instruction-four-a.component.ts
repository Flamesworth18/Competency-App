...
@Component({
  selector: 'app-instruction-four-a',
  templateUrl: './instruction-four-a.component.html',
  styleUrls: ['./instruction-four-a.component.scss']
})
export class InstructionFourAComponent implements OnInit {
  ...
  navigateToPagination(route: string){
    ...
    var basicOptions = this.userInstructionCompetency.fourBasicOptions;
    var intermediateOptions = this.userInstructionCompetency.fourIntermediateOptions;
    var advancedOptions = this.userInstructionCompetency.fourAdvancedOptions;
    var superiorOptions = this.userInstructionCompetency.fourSuperiorOptions;
    ...
    if(basicScore.length >= 6){
      this.userInstructionCompetency.fourBasicResult.competent = true;
    }
    else if(basicScore.length >= 3 && basicScore.length <= 5){
      this.userInstructionCompetency.fourBasicResult.partially = true;
    }
    else if(basicScore.length <= 2){
      this.userInstructionCompetency.fourBasicResult.notYet = true;
    }
    //#endregion

    //#region INTERMEDIATE
    if(intermediateScore.length >= 6){
      this.userInstructionCompetency.fourIntermediateResult.competent = true;
    }
    else if(intermediateScore.length >= 3 && intermediateScore.length <= 5){
      this.userInstructionCompetency.fourIntermediateResult.partially = true;
    }
    else if(intermediateScore.length <= 2){
      this.userInstructionCompetency.fourIntermediateResult.notYet = true;
    }
    //#endregion

    //#region ADVANCED
    if(advancedScore.length >= 6){
      this.userInstructionCompetency.fourAdvancedResult.competent = true;
    }
    else if(advancedScore.length >= 3 && advancedScore.length <= 5){
      this.userInstructionCompetency.fourAdvancedResult.partially = true;
    }
    else if(advancedScore.length <= 2){
      this.userInstructionCompetency.fourAdvancedResult.notYet = true;
    }
    //#endregion

    //#region SUPERIOR
    if(superiorScore.length >= 6){
      this.userInstructionCompetency.fourSuperiorResult.competent = true;
    }
    else if(superiorScore.length >= 3 && superiorScore.length <= 5){
      this.userInstructionCompetency.fourSuperiorResult.partially = true;
    }
    else if(superiorScore.length <= 2){
      this.userInstructionCompetency.fourSuperiorResult.notYet = true;
    }
    //#endregion
  ...
  addToBasicOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userInstructionCompetency.fourBasicOptions.findIndex(o => o.id === option.id);
      this.userInstructionCompetency.fourBasicOptions[optionIndex] = option;
    }
  }
  ...
  addToIntermediateOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userInstructionCompetency.fourIntermediateOptions.findIndex(o => o.id === option.id);
      this.userInstructionCompetency.fourIntermediateOptions[optionIndex] = option;
    }
  }
  ...
  addToAdvancedOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userInstructionCompetency.fourAdvancedOptions.findIndex(o => o.id === option.id);
      this.userInstructionCompetency.fourAdvancedOptions[optionIndex] = option;
    }
  }
  ...
  addToSuperiorOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userInstructionCompetency.fourSuperiorOptions.findIndex(o => o.id === option.id);
      this.userInstructionCompetency.fourSuperiorOptions[optionIndex] = option;
    }
  }
