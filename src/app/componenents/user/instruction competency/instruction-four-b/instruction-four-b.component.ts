...
@Component({
  selector: 'app-instruction-four-b',
  templateUrl: './instruction-four-b.component.html',
  styleUrls: ['./instruction-four-b.component.scss']
})
export class InstructionFourBComponent implements OnInit {
