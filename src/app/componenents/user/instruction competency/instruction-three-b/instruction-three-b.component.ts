...
@Component({
  selector: 'app-instruction-three-b',
  templateUrl: './instruction-three-b.component.html',
  styleUrls: ['./instruction-three-b.component.scss']
})
export class InstructionThreeBComponent implements OnInit {
