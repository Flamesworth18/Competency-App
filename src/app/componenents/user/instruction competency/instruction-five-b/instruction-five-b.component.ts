...
@Component({
  selector: 'app-instruction-five-b',
  templateUrl: './instruction-five-b.component.html',
  styleUrls: ['./instruction-five-b.component.scss']
})
export class InstructionFiveBComponent implements OnInit {
