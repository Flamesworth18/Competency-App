...
@Component({
  selector: 'app-research-one-b',
  templateUrl: './research-one-b.component.html',
  styleUrls: ['./research-one-b.component.scss']
})
export class ResearchOneBComponent implements OnInit {
