...
@Component({
  selector: 'app-research-five-b',
  templateUrl: './research-five-b.component.html',
  styleUrls: ['./research-five-b.component.scss']
})
export class ResearchFiveBComponent implements OnInit {
