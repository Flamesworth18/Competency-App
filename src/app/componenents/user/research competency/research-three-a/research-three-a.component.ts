...
@Component({
  selector: 'app-research-three-a',
  templateUrl: './research-three-a.component.html',
  styleUrls: ['./research-three-a.component.scss']
})
export class ResearchThreeAComponent implements OnInit {
  ...
  navigateToPagination(route: string){
    ...
    var basicOptions = this.userResearchCompetency.threeBasicOptions;
    var intermediateOptions = this.userResearchCompetency.threeIntermediateOptions;
    var advancedOptions = this.userResearchCompetency.threeAdvancedOptions;
    var superiorOptions = this.userResearchCompetency.threeSuperiorOptions;
    ...
    if(basicScore.length >= 6){
      this.userResearchCompetency.threeBasicResult.competent = true;
    }
    else if(basicScore.length >= 3 && basicScore.length <= 5){
      this.userResearchCompetency.threeBasicResult.partially = true;
    }
    else if(basicScore.length <= 2){
      this.userResearchCompetency.threeBasicResult.notYet = true;
    }
    //#endregion

    //#region INTERMEDIATE
    if(intermediateScore.length >= 6){
      this.userResearchCompetency.threeIntermediateResult.competent = true;
    }
    else if(intermediateScore.length >= 3 && intermediateScore.length <= 5){
      this.userResearchCompetency.threeIntermediateResult.partially = true;
    }
    else if(intermediateScore.length <= 2){
      this.userResearchCompetency.threeIntermediateResult.notYet = true;
    }
    //#endregion

    //#region ADVANCED
    if(advancedScore.length >= 6){
      this.userResearchCompetency.threeAdvancedResult.competent = true;
    }
    else if(advancedScore.length >= 3 && advancedScore.length <= 5){
      this.userResearchCompetency.threeAdvancedResult.partially = true;
    }
    else if(advancedScore.length <= 2){
      this.userResearchCompetency.threeAdvancedResult.notYet = true;
    }
    //#endregion

    //#region SUPERIOR
    if(superiorScore.length >= 6){
      this.userResearchCompetency.threeSuperiorResult.competent = true;
    }
    else if(superiorScore.length >= 3 && superiorScore.length <= 5){
      this.userResearchCompetency.threeSuperiorResult.partially = true;
    }
    else if(superiorScore.length <= 2){
      this.userResearchCompetency.threeSuperiorResult.notYet = true;
    }
    //#endregion
  ...
  addToBasicOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userResearchCompetency.threeBasicOptions.findIndex(o => o.id === option.id);
      this.userResearchCompetency.threeBasicOptions[optionIndex] = option;
    }
  }
  ...
  addToIntermediateOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userResearchCompetency.threeIntermediateOptions.findIndex(o => o.id === option.id);
      this.userResearchCompetency.threeIntermediateOptions[optionIndex] = option;
    }
  }
  ...
  addToAdvancedOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userResearchCompetency.threeAdvancedOptions.findIndex(o => o.id === option.id);
      this.userResearchCompetency.threeAdvancedOptions[optionIndex] = option;
    }
  }
  ...
  addToSuperiorOptionList(event: any, option: any) {
    ...
    if ( event.target.checked ) {
      var optionIndex = this.userResearchCompetency.threeSuperiorOptions.findIndex(o => o.id === option.id);
      this.userResearchCompetency.threeSuperiorOptions[optionIndex] = option;
    }
  }
