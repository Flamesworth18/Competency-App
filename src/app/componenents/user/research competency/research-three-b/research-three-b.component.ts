...
@Component({
  selector: 'app-research-three-b',
  templateUrl: './research-three-b.component.html',
  styleUrls: ['./research-three-b.component.scss']
})
export class ResearchThreeBComponent implements OnInit {
