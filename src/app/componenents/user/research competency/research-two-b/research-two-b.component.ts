...
@Component({
  selector: 'app-research-two-b',
  templateUrl: './research-two-b.component.html',
  styleUrls: ['./research-two-b.component.scss']
})
export class ResearchTwoBComponent implements OnInit {
