...
@Component({
  selector: 'app-research-four-b',
  templateUrl: './research-four-b.component.html',
  styleUrls: ['./research-four-b.component.scss']
})
export class ResearchFourBComponent implements OnInit {
