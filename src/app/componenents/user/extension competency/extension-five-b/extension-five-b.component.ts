...
@Component({
  selector: 'app-extension-five-b',
  templateUrl: './extension-five-b.component.html',
  styleUrls: ['./extension-five-b.component.scss']
})
export class ExtensionFiveBComponent implements OnInit {

  instructionCompetencyRoutes = ExtensionCompetencyRoute;
