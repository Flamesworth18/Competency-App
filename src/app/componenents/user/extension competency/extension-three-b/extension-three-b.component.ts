...
@Component({
  selector: 'app-extension-three-b',
  templateUrl: './extension-three-b.component.html',
  styleUrls: ['./extension-three-b.component.scss']
})
export class ExtensionThreeBComponent implements OnInit {
