...
@Component({
  selector: 'app-extension-one-b',
  templateUrl: './extension-one-b.component.html',
  styleUrls: ['./extension-one-b.component.scss']
})
export class ExtensionOneBComponent implements OnInit {
