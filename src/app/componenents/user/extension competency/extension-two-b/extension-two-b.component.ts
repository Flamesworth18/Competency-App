...
@Component({
  selector: 'app-extension-two-b',
  templateUrl: './extension-two-b.component.html',
  styleUrls: ['./extension-two-b.component.scss']
})
export class ExtensionTwoBComponent implements OnInit {
